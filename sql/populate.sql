INSERT INTO users (username, full_name, password, public) VALUES 
('johndoe','John Doe','iodwihad18', 'TRUE'),
('janedoe','Jane Doe','12dasdw', 'FALSE'),
('mike123','Mike Johnson','d2wadd', 'FALSE'),
('sarah_s','Sarah Smith','21ewda', 'TRUE'),
('alice_92','Alice Brown','21edad', 'TRUE'),
('tom_rock','Tom Williams','199duw98dh', 'FALSE'),
('emily89','Emily Green','wdad1', 'FALSE'),
('george22','George Taylor','koiaj89', 'TRUE'),
('claire_97','Claire White','ijjawd', 'FALSE'),
('andrew_h','Andrew Harris','pj8989y', 'FALSE'),
('jessicaL','Jessica Lee','oidwahd1', 'FALSE'),
('chris_k','Chris King','diaowdw2', 'FALSE'),
('oliviaJ','Olivia Jones','dwiaod1', 'TRUE'),
('matthewB','Matthew Brown','op89wd', 'TRUE'),
('rachel_R','Rachel Roberts','plook9wd8', 'FALSE'),
('nathanM','Nathan Moore','dojd92', 'FALSE'),
('victoriaV','Victoria Vance','lolsiwd', 'FALSE'),
('jasonW','Jason Williams','twhdwhuudwh', 'TRUE'),
('emma_R','Emma Richards','asdwad', 'FALSE'),
('tvuong','Derek Vuong','derekvuong', 'TRUE');
